    ...
    BEGIN
    	...
    	FOR hora IN 1..24 LOOP
            ...
            FOR clasif_car IN cur_carrera LOOP
                ...
                call generar_posible_falla (id_event, clasif_car.id_parti_evento_pista, clasif_car.id_parti_equipo, clasif_car.parti_nro_equipo, clasif_car.id_carrera, clasif_car.id_parti_vehiculo,  hora);
